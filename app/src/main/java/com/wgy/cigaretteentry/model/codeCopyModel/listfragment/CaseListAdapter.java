...
public class CaseListAdapter extends BaseAdapter{
    ...
    public CaseListAdapter(Context context,ArrayList<Case> cases){
        mContext=context;
        this.mInflate=LayoutInflater.from(context);
        if (null!=null) {
            this.cases = cases;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        holder.serial_num.setText(Integer.valueOf(position).toString());
        ...
        holder.totalNum.setText(TOTALNUM_TX+Double.valueOf(cases.get(position).getTotalNum()).toString());
