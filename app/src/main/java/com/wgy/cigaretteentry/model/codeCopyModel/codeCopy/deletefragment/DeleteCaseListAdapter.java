...
public class DeleteCaseListAdapter extends BaseAdapter{
    private LayoutInflater mInflate;
    private ArrayList<Case> cases;
    private Context mContext;
    private DeleteFragmentContract.Presenter presenter;
    public DeleteCaseListAdapter(Context context,DeleteFragmentContract.Presenter presenter){
        mContext=context;
        this.presenter=presenter;
        this.mInflate=LayoutInflater.from(context);
        this.cases=new ArrayList<>();
    }
    public DeleteCaseListAdapter(Context context,ArrayList<Case> cases){
        mContext=context;
        this.mInflate=LayoutInflater.from(context);
        if (null!=null) {
            this.cases = cases;
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        final DeleteCaseListAdapter.ViewHolder holder;
        if(convertView==null)
        {
            convertView=mInflate.inflate(R.layout.case_list, null);
            holder=new DeleteCaseListAdapter.ViewHolder();
            ...
            holder=(DeleteCaseListAdapter.ViewHolder)convertView.getTag();
        }
        ...
        holder.enter.setText(DELETE_ENTER_BN_TX);
        holder.enter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                presenter.beginDeleteCase(position);
            }
        });
        return convertView;
    }
    ...
    public final static String DELETE_ENTER_BN_TX="点击删除";
}
